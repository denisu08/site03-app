...
{/if}
				<ul id="header_employee_box">
					...
					{if {$base_url}}
					<li>
						<a href="{if isset($base_url_tc)}{$base_url_tc|escape:'html':'UTF-8'}{else}{$base_url|escape:'html':'UTF-8'}{/if}" id="header_foaccess" class="_blank" title="{l s='View my hotel'}">
							<span class="string-long">{l s='My hotel'}</span>
							<span class="string-short">{l s='Hotel'}</span>
						</a>
